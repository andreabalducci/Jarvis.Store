                    ...
                    new Example
                    {
                        ...
                        Children = new[]
                        {
                            ...
                            new Example
                            {
                                ...
                                Icon = "&#xe871",
                                Tags = new[]
                                    { "datagrid", "bind", "load", "data", "loaddata", "odata", "service", "rest" }
                            },
                            new Example
                            {
                                Name = "Dynamic data",
                    ...
                    new Example
                    {
                        ...
                        Children = new[]
                        {
                            ...
                            new Example
                            {
                                ...
                                Tags = new[]
                                    { "datagrid", "bind", "load", "data", "loaddata", "virtualization", "ondemand" }
                            },
                        }
                    },
                    new Example
                    ...
                    new Example
                    {
                        ...
                        Children = new[]
                        {
                            ...
                            new Example
                            {
                                ...
                                Tags = new[]
                                    { "group", "grouping", "footer", "template", "datagrid", "table", "dataview" }
                            }
                        }
                    },
                    new Example()
